...
public class Board {
	...
	//Iterate through the cells array to create each cell	
	...
	//Checks each cell sequentially and returns false if an empty cell is encountered. If no empty cells are found, it returns true and signals a draw.
	...
	public boolean hasWon(Player thePlayer, int playerRow, int playerCol) {
		...
		//Checks if player has 3-in-a-diagnoal in the opposite direction from above.
